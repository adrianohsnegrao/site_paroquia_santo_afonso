...
export default function EditarPastoralPage({
  ...
  if (!pastoral) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-gray-500">Pastoral/Movimento não encontrado(a).</p>
      </div>
    );
  }
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            id="descricao_curta"
            rows={2}
            defaultValue={pastoral.descricao_curta || ''}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg border border-gray-100">
          <div>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                name="destaque_home"
                defaultChecked={pastoral.destaque_home}
          ...
          <div>
            ...
            <select
              name="status"
              id="status"
              defaultValue={pastoral.status || 'ativo'}
