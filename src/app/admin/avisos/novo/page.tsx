  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <PageHeader
        ...
        description="Preencha os campos abaixo para publicar um novo aviso ou comunicado."
      />

      <FormCard onSubmit={handleSubmit}>
        <Field label="Título" htmlFor="titulo" required>
          <Input type="text" name="titulo" id="titulo" required placeholder="Ex: Mudança no horário de missa" />
        </Field>

        <Field label="Resumo" htmlFor="resumo" hint="Aparece nos cards de listagem.">
          <Textarea name="resumo" id="resumo" rows={3} placeholder="Breve descrição que aparecerá nos cards de listagem..." />
        </Field>
